...
MIGRATION_MODULES = {"sites": "song_swipe.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "song_swipe.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Michal Lesniowski""", "michal-lesniowski@example.com")]
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "allauth.account.auth_backends.AuthenticationBackend",
        # "song_swipe.song_rating.authentication.SpotifyAuthentication"
    ),
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Song swipe API",
    "DESCRIPTION": "Documentation of API endpoints of Song swipe",
    "VERSION": "1.0.0",
